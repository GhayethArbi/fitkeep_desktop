...
public class ProductListController {
    ...
    void addToCart(ActionEvent event) {
       ...
       ProductService p = new ProductService();
        User userId = u.getUserById(1); // Implement this method based on your user authentication logic
        int quantity = 0;
        try{
        ...
        if (selectedProduct != null) {
            ...
            panier.setQuantite(quantity); // Set the quantity to 1 for now, you can adjust this as needed
            panier.setTotalPrice(selectedProduct.getPrice()*quantity); // Assuming getPrice() returns the product price
