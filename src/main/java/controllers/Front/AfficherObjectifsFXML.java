...
public class AfficherObjectifsFXML implements Initializable {
    ...
    private int etatClick=  0;
    private int idObjectifSelected;
    ...
    private void handleItemObjCreeClick(itemObjectifCreeFXML itemObjectifCreeFXML) {
        ...
        this.idObjectifSelected = (Integer) itemObjectifCreeFXML.getObjectId();
    }
    ...
    public void createOrUpdateObj(MouseEvent mouseEvent) {
      ...
      if(etatClick==-1){
        try {
            ...
            objectif.setTotalCalories(Integer.valueOf(totalCalories));
            objectif.setTotalDuree(Integer.valueOf(totalDuration));
